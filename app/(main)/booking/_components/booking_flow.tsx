...
import { ChevronRight, Check, Calendar, Clock, User, ShoppingBag, Car } from 'lucide-react';
...
const BookingFlow = ({ user, userVehicles }: BookingFlowProps) => {
    ...
    const handleContinue = async () => {
        if (currentStep === 1 && selectedPackage) {
            ...
            setCurrentStep(5);
        } else if (currentStep === 5 && selectedVehicle) {
            setCurrentStep(6);
        }
    };
    ...
    const canContinue = () => {
        switch (currentStep) {
            ...
            case 5: return selectedVehicle !== null;
    ...
    const steps = [
        ...
        { number: 5, label: 'Choose your car', icon: Car },
        { number: 6, label: 'Details', icon: Check }
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 mt-20">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 min-h-96">
                    {loading ? (
                        ...
                        <>
                            ...
                            {/* Step 5: Choosing user vehicle */}
                            {currentStep === 5 && (
                                <div>
                                    <h2 className="text-2xl font-bold mb-6">Choose the Car you want to Book</h2>
                                    {userVehicles?.map((vehicle) => (
                                        <div key={vehicle.id} onClick={() => setSelectedVehicle(vehicle)} className={`border-2 rounded-lg p-6 cursor-pointer transition ${selectedVehicle?.id === vehicle.id
                                            ? 'border-blue-600 bg-blue-50 shadow-md'
                                            : 'border-gray-200 hover:border-blue-400'
                                            }`} >
                                ...
                                <div>
                                    ...
                                    <div className="space-y-6">
                                        <div className='border-2 border-gray-200 rounded-lg p-6'>
                                            ...
                                            <div className='flex justify-between'>
                                                <img src={selectedVehicle?.imageURL} alt="Vehicle image" className='w-[50%]' />
                                                <div className='space-y-3 w-[45%]'>
                                                    ...
                                                    <div className='flex justify-between'>
                                                        <span className='text-gray-600'>Purchased Year:</span>
                                                        <span className='font-semibold'>{selectedVehicle?.year}</span>
                                                    </div>
                                                    <div className='flex justify-between'>
                                                        <span className='text-gray-600'>Mileage:</span>
                                                        <span className='font-semibold'>{selectedVehicle?.mileage} km</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                {/* Price Summary (visible on steps 2-6) */}
